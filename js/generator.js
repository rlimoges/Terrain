...
var app = new function () {
    ...
    app.uniforms = {
        ...
        waterLevel: { type: "f", value: 75.0 },
        mountainLevel: { type: "f", value: 200.0 },
        blur: { type: "f", value: 0.0 },
        lowColor: { type: "v3", value: new THREE.Vector3(0.2, 1.0, 0.2) },
        lowMode: { type: "f", value: 2.0 },
        lowFX: { type: "f", value: 1.0 },
        mediumColor: {type: "v3", value: new THREE.Vector3(0.2, 1.0, 0.2) },
        mediumMode: { type: "f", value: 1.0 },
        medFX: { type: "f", value: 0.0 },
        highColor: {type: "v3", value: new THREE.Vector3(0.2, 1.0, 0.2) },
        highMode: { type: "f", value: 1.0 },
        highFX: { type: "f", value: 0.0 },
